...
export default defineMessages({
  ...
  licenseP1: {
    ...
    defaultMessage:
      `{ARASAAC} is a brand of the Government of Aragon (Spain), registered in the Spanish Patent and 
  ...
  licenseP4: {
    ...
    defaultMessage:
      `For any other use they are strictly prohibited, without written authorization of the copyright holders, 
  ...
  licenseP7: {
    ...
    defaultMessage:
      `The pictographic symbols used are the property of the Government of Aragón and have been created by Sergio Palao 
