          ...
          <aside style={styles.thumbsContainer}>
            {files.size ? (
              ...
              <p style={{ margin: "20px", textAlign: "center" }}>
                {exclusive ? (
                  onlyImage ? (
                    <FormattedMessage {...messages.langScreenshotsInfo} />
                  ) : (
                    <FormattedMessage {...messages.langFilesInfo} />
                  )
                ) : onlyImage ? (
                  <FormattedMessage {...messages.addMaterialImages} />
                ) : (
