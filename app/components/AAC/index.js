...
const AAC = () => {
  return (
    <div>
      <P>From ARASAAC we’d like to thank both Carmen Basil and the Unitat de Tècniques Augmentatives de Comunicació (UTAC) for their collaboration at drafting this section in our website.</P>
      ...
      <P>The Augmentative and Alternative Systems of Communication (SAAC) are ways of expression different from spoken language, that aim at increasing (augmentative) and/or compensate (alternative)
      ...
      <P>Augmentative and Alternative Communication (AAC) is not incompatible but complementary to the rehab of natural speech. Besides, it may help to its success whenever it is posible. Thus, you
      ...
      <P>Augmentative and Alternative Communication includes different systems of symbols, both graphic (pictures, drawings, pictograms, words or letters) and gestural (mimicry, gestures or hand signals) and,
      in the former case, it also requires the use of support products. The different systems of symbols adapt to the needs of people of varied ages and uneven motor , cognitive and linguistic skills. </P>
      <P>The support products for communication include technological resources such as artificial speech communicators, personal computers or tablets with special programmes that allow different forms of
      ...
      <P>There are different strategies and instruments to access computers, communicators, communication boards or books -generically called strategies and products of support for access- such as pointers,
      ...
      <P>In the case of gestural symbols, this gradation encompasses from the use of mimicry and commonly used gestures to the use of hand signs, generally in the order of spoken language; this is what is called
      ...
      <P>Graphic symbols cover from very simple systems based on pictures or photographs to systems more and more complex like pictographic systems or traditional orthography (letters, words and sentences).
      ...
      <P>Pictographic systems are applied to people who are illiterate because of age or disability. They offer the advantage of allowing, from a very basic level of communication -that is adaptable for people
      ...
      <P>We can divide support products for communication into basic and technological. The boards of communication are basic support products that consist of surfaces of diverse materials where graphic symbols for
      communication are placed (photographs, pictograms, letters, words and / or sentences) that the person will indicate to communicate. When the sysmbols are distributed on different pages, we call them communication
      books.
      </P>
      <P>Among the technological products we find electronic communicators especially designed for that purpose, and personal computers or tablets with special programmes that turn them into communicators.
      ...
      <P>Direct selection: the user points at or presses the buttons directly with the finger, the sight or other parts of the body in order to indicate the pictograms, words or letters he/she wants to communicate.
      The pointers of different types are examples of support products that can facilitate the selection or direct access.</P>
      <P>Mouse selection: it is only for electronic products. It consists in using the mouse to access keyboards or grids with symbols to communicate through the screen.  You can use a wide variety of adapted
      mouse devices like joysticks, trackballs, facial mouse devices (controlled by head movements), mouse devices controlled with the sight or the multimouse, which consists of five keys or switches.  </P>
      <P>Dependent exploration or scanning: just for boards or books. The interlocutor points at the symbols or letters to be communicated one by one, by groups, rows or columns, until the assisted speaker indicates
      with a gesture that the letter/word has been identified.</P>
      <P>Independent exploration or scanning: just for electronic products. In this case it is the communicator or the computer that shows the different options to be communicated until the assisted speaker chooses
      the one he/she wants by pressing a switch. There are many types of switches that can be activated with different parts of the body.</P>
      <P>Coded selection: each symbol or letter has a code (for instance a number of two or three digits or a colour and a number) so that the assisted speaker indicates this code by direct selection or scanning to
      transmit the symbol or letter. In this way, with a few keys or grids he/she can access a great number of symbols.</P>
      ...
      <P>The intervention process has to begin with an evaluation of the capacities, abilities, necessities and wishes of the person, as well as the features, supports, requirements and restrictions of his/her
      ...
      <P>The empowerment and teaching should be addressed both to the person and to his/her environment, including all the contexts where he/she participates or wants to take part in, as well as all the meaningful
