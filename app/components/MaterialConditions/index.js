    ...
    return (
      ...
      >
        <div dir={direction}>
          ...
          <P><FormattedMessage {...messages.requirementsP2} /></P>
          <P><FormattedMessage {...messages.requirementsP3} /></P>
          ...
          <ul style={isRtl ? { marginRight: '20px', listStyleType: 'square', fontWeight: 300 } : { marginLeft: '20px', listStyleType: 'square', fontWeight: 300 }}>
            <li>
              ...
              <em>
                <strong><FormattedMessage {...messages.pictogramsAuthor} />&nbsp;</strong>
            Sergio Palao&emsp;
            <strong><FormattedMessage {...messages.origin} /> &nbsp;</strong>
            ARASAAC (http://arasaac.org)&emsp;
            <strong><FormattedMessage {...messages.license} />&nbsp; </strong>
            CC (BY-NC-SA)&emsp;
            <strong><FormattedMessage {...messages.author} /> &nbsp;</strong>
            ...
          </em>
            </li>

            <li>
              <P important={true}><FormattedMessage {...messages.translationQuote} /></P>
              <P><FormattedMessage {...messages.translationQuoteDesc} /></P>
            ...
            <strong><FormattedMessage {...messages.author} /> &nbsp;</strong>
            ...&emsp;
            <strong><FormattedMessage {...messages.translator} /> &nbsp;</strong>
            ...
          </em>
            </li>

            <li>
              <P important={true}><FormattedMessage {...messages.adaptationQuote} /></P>
              <P><FormattedMessage {...messages.adaptationQuoteDesc} /></P>
            ...
            <strong><FormattedMessage {...messages.author} /> &nbsp;</strong>
            ...&emsp;
            <strong><FormattedMessage {...messages.adaptedBy} /> &nbsp;</strong>
            ...
          </em>
          ...
          <H2 primary={true}><FormattedMessage {...messages.suggestions} /></H2>
          <P><FormattedMessage {...messages.suggestionsDesc} /></P>
          <H2 primary={true}><FormattedMessage {...messages.publication} /></H2>
          <P><FormattedMessage {...messages.publicationDesc} /></P>
          <Checkbox
