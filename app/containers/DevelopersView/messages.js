...
export default defineMessages({
  ...
  termsOfUseDesc: {
    ...
    defaultMessage: 'The ARASAAC API is only available for non-commercial applications. Make sure you meet our license terms.'
  },
  license: {
  ...
  grantTypesDesc: {
    ...
    defaultMessage: ' Depending on the type of application and specific needs, an specific grant type or other must be implemented. Do not hesitate to contact us for more information.'
  }
