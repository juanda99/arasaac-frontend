...
export default defineMessages({
  userNotActivated: {
    ...
    defaultMessage: 'You have already signed up. Please check your email to verify your account.'
  },
  userConflict: {
    id: 'signup.userConflict',
    description: 'Error description creating new user',
    defaultMessage: 'You have already signed up and confirmed your account. Did you forget your password?'
  },
  userCreated: {
    id: 'signup.userCreated',
    description: 'New user created message',
    defaultMessage: 'An email has been sent to you. Please check it to verify your account.'
  },
  userNotCreated: {
