...
export class PrivacyPolicyEs extends React.PureComponent {
  ...
  render() {
    return (
      <ReadMargin>
        ...
        <P>
          Esta política es aplicable tanto a la información recogida a través a
          través del sitio web{' '}
          <A href="https://www.arasaac.org">www.arasaac.org</A> como a las
          aplicaciones dependientes del mismo.
        </P>

        <P>
          El tratamiento de los datos de carácter personal recogidos en esta web
          y en los portales y aplicaciones asociados estará sujeto a la
          legislación vigente en materia de protección de datos, el RGPD y demás
          normativa de aplicación. De esta manera se garantiza en todo momento
          la privacidad de los usuarios, así como el secreto y seguridad de sus
          datos personales.
        </P>
        ...
        <P>
          ...
          abarcando las reclamaciones en vía administrativa y judicial, así como
          las solicitudes en materia de transparencia.
        </P>
        <P>
          El órgano responsable del Registro de Actividades de Tratamiento es la
        ...
        <P>
          ...
          tratamientos de sus datos personales hechos por el Gobierno de Aragón.
          Se podrán ejercitar los derechos de acceso, rectificación, supresión,
          portabilidad de los datos y los de limitación y oposición a los
          tratamientos. También se podrá ejercitar el derecho a no ser objeto de
          decisiones basadas únicamente en el tratamiento automatizado de los
          datos, incluida la elaboración de perfiles. Los derechos se
          ejercitarán ante el órgano responsable del tratamiento.
        </P>
        ...
        <P>
          ...
          General (Avda. Ranillas nº 5 D 50.071 Zaragoza), o en la dirección de
          correo electrónico dginnovacionyfp@aragon.es, de conformidad con lo
          dispuesto en el Reglamento General de Protección de Datos. Podrá
        ...
        <P>
          También se puede presentar una reclamación ante la Agencia Española de
          Protección de Datos en el caso de que considere que el tratamiento de
          sus datos no está siendo adecuado.
        </P>
        ...
        <P>
          La única información que se recoge de los usuarios es el formulario de
          alta (nombre, correo electrónico, empresa y sitio web). La información
          se guarda en servidores pertenecientes al Gobierno de Aragón y
          localizados en la Unión Europea.
        </P>
        <P>
          Se utilizan una serie de cookies para el funcionamiento del sitio web
          y las aplicaciones, así como la herramienta Google Analytics con fines
          exclusivamente estadísticos. Toda esta información aparece detallada
