...
const makeSelectIdPictogram = () => (_, ownProps) => ownProps.params.idPictogram
const makeSelectLocale = () => (_, ownProps) => ownProps.params.locale

const selectPictogramsViewDomain = (state) => state.get('pictogramsView')

export const makePictogramByIdSelector = () => createSelector(
  selectPictogramsViewDomain, makeSelectLocale(), makeSelectIdPictogram(),
