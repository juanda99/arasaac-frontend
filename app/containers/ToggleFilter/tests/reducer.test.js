...
describe('toggleFilterReducer', () => {
  ...
  it('should handle the toggleFilter actions correctly for pictograms', () => {
    const expectedResult = initialState
      .setIn(['pictograms', 'catalog'], false)
    expect(toggleFilterReducer(initialState, toggleFilter('pictograms', 'catalog'))).toEqual(expectedResult)
  })
  it('should handle the toggleFilter actions correctly for materials', () => {
    const expectedResult = initialState
      .setIn(['materials', 'area'], false)
    expect(toggleFilterReducer(initialState, toggleFilter('materials', 'area'))).toEqual(expectedResult)
  })
})
