...
export default defineMessages({
  ...
  translationsWarning: {
    ...
    defaultMessage:
      "Pictogram search doesn't work properly in your language because translations are not complete.",
  },
  translationStatus: {
  ...
  pageDesc: {
    ...
    defaultMessage:
      'Open source symbols for Augmentative and Alternative Communication',
  },
  closeWarning: {
